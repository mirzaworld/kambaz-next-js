...
const { Body: CardBody, Title: CardTitle, Text: CardText, Img: CardImg } = Card;
    ...
    return (
        <div id = "wd-dashboard">
            ...
            <div id = "wd-dashboard-courses">
                ...
                <Col className = "wd-dashboard-course" style = {{width: "300px"}}>
                    <Card>
                        <Link href = "/courses/1236" className = "wd-dashboard-course-link text-description-none text-dark" >
